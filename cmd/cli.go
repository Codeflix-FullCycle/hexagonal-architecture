...
func init() {
	...
	cliCmd.Flags().StringVarP(&productId, "id", "i", "", "Product a product")
	cliCmd.Flags().StringVarP(&productName, "name", "n", "", "Name a product")
	cliCmd.Flags().Float64VarP(&productPrice, "price", "p", 0, "Price a product")
