...
import (
	...
	dbInfra "github.com/Codeflix-FullCycle/hexagonal-architecture/adapters/db"
...
var productDB = dbInfra.NewProduct(db)
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".hexagonal-architecture" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigType("yaml")
		viper.SetConfigName(".hexagonal-architecture")
	}
